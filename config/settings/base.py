...
# Security and deployment config loaded dynamically from .env
...
CSRF_TRUSTED_ORIGINS = config('CSRF_TRUSTED_ORIGINS', default='https://new.jbnuu.uz,https://api.jbnuu.uz', cast=Csv())
